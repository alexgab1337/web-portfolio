...
function Project({ title, description, tags, imageUrl }) {
  ...
  return (
    <motion.section
      className="group bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden pr-8 relative even:pl-8 hover:bg-gray-200 transition mb-8 rounded-md"
      ref={ref}
      style={{
        scale: scaleProgess,
