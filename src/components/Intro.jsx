    ...
    return (
        <section className=" text-center">
            ...
            >
                ...
                <span>and a</span> <span className="font-bold"> student at UIC.</span> I like
                building <span className="italic">things on the web</span>. My current focus is{" "}
                <span className="underline">React (Next.js)</span>.
            </motion.h1>

            <motion.div className="flex flex-row items-center justify-center gap-4 px-4 text-lg font-medium" 
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}>
                ...
                <a href="https://t.me/seanceo" target="_blank" className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition"> <FaTelegram className="text-[1.5rem]"/> </a>

                <a href="https://github.com/alexgab1337" target="_blank" className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full text-[1.35rem] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition"> <FaGithub className="text-[1.5rem]"/> </a>
            </motion.div>
        </section>
    );
}
